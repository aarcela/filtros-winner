...
function Page() {
    return (
        <>
            <ApplicationFilter />
            <section className="flex flex-1 bg-search-bg bg-no-repeat bg-bottom bg-cover bg-black bg-opacity-70 w-full items-center bg-blend-darken sm:px-20 flex-col sm:flex-row order-1 sm:order-2">
                <div>

...
function Page() {
    return (
        <>
            <ApplicationFilter />
            <section className="flex flex-1 bg-search-bg-mobile sm:bg-search-bg md:bg-search-bg-medium bg-no-repeat bg-center bg-cover  w-full items-center bg-blend-darken sm:px-20 flex-col sm:flex-row order-1 sm:order-2">
                <div>
